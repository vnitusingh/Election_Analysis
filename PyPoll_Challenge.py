...
with open(file_to_save, "w") as txt_file:
    ...
    for county in counties:
        ...
        county_results = (f"{county}: {county_votes_percentage:.1f}% ({county_vote:,})\n")
        ...
        if (county_vote > largest_county_votes_count) and (county_votes_percentage > county_winning_percentage):
            largest_county_votes_count = county_vote
            largest_turnout_county = county
            county_votes_percentage =  county_winning_percentage
